...
public interface DeliveryHistoryDetailRepository extends JpaRepository<DeliveryHistoryDetail, Long> {
    List<DeliveryHistoryDetail> findByDeliveryHistory_DeliveryHistoryIdAndDeliveryHistory_DeliveryHistoryIsDeletedFalseAndDeliveryHistoryDetailIsDeletedFalse(Long deliveryHistoryId);
}
